...
from constants.scraping import ARTIST_URI, ARTIST_URL, SPOTIFY_BASE_URL, TRACK_URI, TRACK_URL
...
def init_spotify_scraper_daos() -> Tuple[SpotifyArtistScraperDAO, SpotifyTrackScraperDAO]:
    ...
    track_scrap_dao = SpotifyTrackScraperDAO(access_token, track_client_token, user_agent, track_hash_value, cookies)
    artist_scrap_dao = SpotifyArtistScraperDAO(access_token, artist_client_token, user_agent, artist_hash_value, cookies)
