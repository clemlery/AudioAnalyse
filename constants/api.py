...
# Endpoints player
SPOTIFY_RECENT_PLAY_HISTORY_URL: Final[str] = (
...
SPOTIFY_PLAYLIST_TRACKS_URL_TEMPLATE: Final[str] = (
...
SPOTIFY_CHECK_FOLLOWED_ARTISTS_URL_TEMPLATE: Final[str] = (
    f"{SPOTIFY_API_BASE_URL}/me/following/contains?type=artist"
)

# Constantes pour le fichier album_fetch_dao :
SPOTIFY_ALBUMS_URL: Final[str] = f"{SPOTIFY_API_BASE_URL}/albums"
SPOTIFY_ALBUM_TRACKS_URL_TEMPLATE: Final[str] = (
    f"{SPOTIFY_API_BASE_URL}/albums/{{album_id}}/tracks"
)
SPOTIFY_SAVED_ALBUMS_URL: Final[str] = f"{SPOTIFY_API_BASE_URL}/me/albums"
SPOTIFY_CHECK_SAVED_ALBUMS_URL: Final[str] = (
    f"{SPOTIFY_API_BASE_URL}/me/albums/contains"
)
...
SCOPES: Final[str] = (
    "user-read-private user-read-email user-top-read user-read-recently-played user-library-read user-follow-read"
)
