...
from sqlalchemy import BigInteger, Column, DateTime, ForeignKey, Integer, Sequence, UniqueConstraint, text
from models.sql_alchemy_models.base import Base
from sqlalchemy.orm import relationship

track_id_seq = Sequence(
    'track_metrics_snapshot_id_seq',
    start=0,
    increment=1,
...
artist_id_seq = Sequence(
    'artist_metrics_snapshot_id_seq',
    start=0,
    increment=1,
    metadata=Base.metadata
)
